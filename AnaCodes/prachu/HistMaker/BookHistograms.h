void AnaScript::BookHistograms(){
  ...
  h.evt2LSS[9]  = new TH1F("lep1_pt",  "lep1_pt",  50, 0, 500);
  h.evt2LSS[10]  = new TH1F("lep1_eta", "lep1_eta", 100, -4, 4);
  h.evt2LSS[11] = new TH1F("lep1_phi", "lep1_phi", 100, -4, 4);
  h.evt2LSS[12] = new TH1F("lep1_iso", "lep1_iso", 200, 0, 1);
  h.evt2LSS[13]  = new TH1F("lep1_sip3d", "lep1_sip3d", 500, 0, 50);
  h.evt2LSS[14] = new TH1F("lep1_mt",  "lep1_mt",  50, 0, 500);

  h.evt2LSS[15] = new TH1F("dilep_pt",  "dilep_pt",  50, 0, 500);
  h.evt2LSS[16] = new TH1F("dilep_eta", "dilep_eta", 100, -10, 10);
  h.evt2LSS[17] = new TH1F("dilep_phi", "dilep_phi", 100, -4, 4);
  h.evt2LSS[18] = new TH1F("dilep_mass","dilep_mass",50, 0, 500);
  h.evt2LSS[19] = new TH1F("dilep_mt",  "dilep_mt",  50, 0, 500);
  h.evt2LSS[20] = new TH1F("dilep_deta", "dilep_deta", 100, 0, 6);
  h.evt2LSS[21] = new TH1F("dilep_dphi", "dilep_dphi", 100, 0, 6);
  h.evt2LSS[22] = new TH1F("dilep_dR",   "dilep_dR",   100, 0, 6);
  h.evt2LSS[23] = new TH1F("dilep_ptratio","dilep_ptratio",100, 0, 1);

  h.evt2LSS[24] = new TH1F("HT", "HT", 20, 0, 500);
  h.evt2LSS[25] = new TH1F("LT", "LT", 20, 0, 500);
  h.evt2LSS[26] = new TH1F("STvis", "STvis", 50, 0, 500);
  h.evt2LSS[27] = new TH1F("ST", "ST", 50, 0, 500);
  h.evt2LSS[28] = new TH1F("STfrac", "STfrac", 100, 0, 1.1); //For nJet-==0, STfrac=1
  h.evt2LSS[29] = new TH1F("HTMETllpt", "HTMETllpt", 50, 0, 500);
  h.evt2LSS[30] = new TH1F("metpt", "MET", 50, 0, 500);
  h.evt2LSS[31] = new TH1F("metphi", "MET_phi", 100, -4, 4);
  
  h.evt2LSS[32] = new TH1F("dphi_metlep0",    "dilep_metlep0",    100, 0, 4);
  h.evt2LSS[33] = new TH1F("dphi_metlep1",    "dilep_metlep1",    100, 0, 4);
  h.evt2LSS[34] = new TH1F("dphi_metdilep",   "dilep_metdilep",   100, 0, 4);
  h.evt2LSS[35] = new TH1F("dphi_metlep_max", "dilep_metlep_max", 100, 0, 4);
  h.evt2LSS[36] = new TH1F("dphi_metlep_min", "dilep_metlep_min", 100, 0, 4);
  
  for(int i=0; i<37; i++) h.evt2LSS[i]->Sumw2();
