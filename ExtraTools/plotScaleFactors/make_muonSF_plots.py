#-----------------------------------------------------------------------------------------------------
# input files:
#1. ../../AnalysisScripts/Corrections/SFfromPOG/muon_id_sf.txt
#2. ../../AnalysisScripts/Corrections/SFfromPOG/muon_iso_sf.txt
# columns: campaign >> etalow >> etahigh >> ptlow >> pthigh >> down >> sf >> up
#-----------------------------------------------------------------------------------------------------
...
def make_muonSF_plot(df, correction_name, campaign_dict, run, yrange=(0.99, 1.01)):
    ...
    for etalow, etahigh in eta_bins:
        ...
        if not ax.lines: plt.close(fig); continue
