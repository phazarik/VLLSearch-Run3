...
//Electron Reco
double AnaScript::Electron_2016UL_Reco_postVFP(float pt, float eta){
...
//Electron IdIso
double AnaScript::Electron_2016UL_IDIso_postVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(10<pt && pt<=20){
...
//Muon Reco
double AnaScript::Muon_2016UL_Reco_postVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon ID
double AnaScript::Muon_2016UL_ID_postVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon Iso
double AnaScript::Muon_2016UL_Iso_postVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Taus AntiJet
double AnaScript::Tau_2016UL_AntiJet_postVFP(float pt){
  double scale_factor = 1.0;//default value
...
//Taus AntiEle
double AnaScript::Tau_2016UL_AntiEle_postVFP(float eta){
  double scale_factor = 1.0;//default value
...
//Taus AntiMu
double AnaScript::Tau_2016UL_AntiMu_postVFP(float eta){
  double scale_factor = 1.0;//default value
