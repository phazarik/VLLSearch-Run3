...
// 2016 preVFP MC
float AnaScript::TrigEff_2016preVFP_IsoMu24_MC(float pt, float eta){
...
// 2016 preVFP Data
float AnaScript::TrigEff_2016preVFP_IsoMu24_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2016 postVFP MC
float AnaScript::TrigEff_2016postVFP_IsoMu24_MC(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2016 postVFP Data
float AnaScript::TrigEff_2016postVFP_IsoMu24_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2017 MC
float AnaScript::TrigEff_2017_IsoMu27_MC(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2017 Data
float AnaScript::TrigEff_2017_IsoMu27_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
  else if(fabs(eta)<=1.479){
...
//2018 MC
float AnaScript::TrigEff_2018_IsoMu24_MC(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
//2018 Data
float AnaScript::TrigEff_2018_IsoMu24_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2016 preVFP MC
float AnaScript::TrigEff_2016preVFP_Ele27WPTightGsf_MC(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2016 preVFP Data
float AnaScript::TrigEff_2016preVFP_Ele27WPTightGsf_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2016 postVFP MC
float AnaScript::TrigEff_2016postVFP_Ele27WPTightGsf_MC(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2016 postVFP Data
float AnaScript::TrigEff_2016postVFP_Ele27WPTightGsf_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2017 MC
float AnaScript::TrigEff_2017_Ele32WPTightGsf_MC(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2017 Data
float AnaScript::TrigEff_2017_Ele32WPTightGsf_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2018 MC
float AnaScript::TrigEff_2018_Ele32WPTightGsf_MC(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
...
// 2018 Data
float AnaScript::TrigEff_2018_Ele32WPTightGsf_Data(float pt, float eta){
  float eff = 0.0; //default value
  if( pt<10 || eta>2.4 ) return 0.0;
