...
//Electron Reco
double AnaScript::Electron_2017UL_Reco(float pt, float eta){
...
//Electron IdIso
double AnaScript::Electron_2017UL_IDIso(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(10<pt && pt<=20){
...
//Muon Reco
double AnaScript::Muon_2017UL_Reco(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon ID
double AnaScript::Muon_2017UL_ID(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon Iso
double AnaScript::Muon_2017UL_Iso(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//--------------------------
//Tau AntiJet SF
double AnaScript::Tau_2017UL_AntiJet(float pt){
  double scale_factor = 1.0;//default value
...
double AnaScript::Tau_2017UL_AntiEle(float eta){
  double scale_factor = 1.0;//default value
...
double AnaScript::Tau_2017UL_AntiMu(float eta){
  double scale_factor = 1.0;//default value
