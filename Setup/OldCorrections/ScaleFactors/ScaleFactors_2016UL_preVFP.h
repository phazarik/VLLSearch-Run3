...
//Electron Reco
double AnaScript::Electron_2016UL_Reco_preVFP(float pt, float eta){
...
//Electron IdIso
double AnaScript::Electron_2016UL_IDIso_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(10<pt && pt<=20){
...
//Muon Reco
double AnaScript::Muon_2016UL_Reco_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon ID
double AnaScript::Muon_2016UL_ID_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon Iso
double AnaScript::Muon_2016UL_Iso_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Taus AntiJet
double AnaScript::Tau_2016UL_AntiJet_preVFP(float pt){
  double scale_factor = 1.0;//default value
...
//Taus AntiEle
double AnaScript::Tau_2016UL_AntiEle_preVFP(float eta){
  double scale_factor = 1.0;//default value
...
//Taus AntiMu
double AnaScript::Tau_2016UL_AntiMu_preVFP(float eta){
  double scale_factor = 1.0;//default value
