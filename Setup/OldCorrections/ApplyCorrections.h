...
//Main:
double AnaScript::LeptonIDSF(int id, float pt, float eta){
...
float AnaScript::SingleLepTrigger_eff(int id, float pt, float eta){
  float eff = 1.0; 
...
float AnaScript::TrigEff_2016_IsoMu24_MC(float pt, float eta){
...
float AnaScript::TrigEff_2016_IsoMu24_Data(float pt, float eta){
  float lumi_preVFP  = 5747.0+2573.0+4242.0+4025.0+3105.0;
  float lumi_postVFP = 7576.0+8651.0;
...
float AnaScript::TrigEff_2016_Ele27WPTightGsf_MC(float pt, float eta){
  float lumi_preVFP  = 5747.0+2573.0+4242.0+4025.0+3105.0;
  float lumi_postVFP = 7576.0+8651.0;
...
float AnaScript::TrigEff_2016_Ele27WPTightGsf_Data(float pt, float eta){
  float lumi_preVFP  = 5747.0+2573.0+4242.0+4025.0+3105.0;
  float lumi_postVFP = 7576.0+8651.0;
...
double AnaScript::Electron2016SF(float pt, float eta){
...
double AnaScript::Muon2016SF(float pt, float eta){
  //For 2016, the scale factors are calculated differently for preVFP and postVFP.
  //Later they are combined with luminosity as the weight.
  double lumi_preVFP  = 5747.0+2573.0+4242.0+4025.0+3105.0;
  double lumi_postVFP = 7576.0+8651.0;
...
double AnaScript::Tau2016SF(float pt, float eta){
  //For 2016, the scale factors are calculated differently for preVFP and postVFP.
  //Later they are combined with luminosity as the weight.
  double lumi_preVFP  = 5747.0+2573.0+4242.0+4025.0+3105.0;
  double lumi_postVFP = 7576.0+8651.0;
